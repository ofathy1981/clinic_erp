...
<form ethod="POST" action="{{ route('doctor.search') }}">
	@csrf
			...
			<label class="focus-label">doctor phone</label>
			</div>
			</div>
			<div class="col-sm-6 col-md-3">
			<div class="form-group form-focus">
			...
			<a href="{{route('doctor.show',$item->id)}}"><img class="avatar" src="assets/img/user.jpg" alt=""></a>
			</div>
			...
			<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="{{route('doctor.show',$item->id)}}">{{   $item->name }}</a></h4>
