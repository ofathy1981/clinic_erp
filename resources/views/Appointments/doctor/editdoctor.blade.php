...
<h5 class="text-uppercase mb-0 mt-0 page-title">Edit doctor</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<input type="text" class="form-control" name="first_name"  value="{{ $doctor->name }}">
</div>
<div class="form-group">
<label>Phone</label>
<input type="text" class="form-control" name="nationality"  value="{{ $doctor->phone }}">
</div>
<div class="form-group" name="social_case">
	<label>Address</label>
	<select class="form-control select" name="social_case"  value="{{ $doctor->address }}">
...
<div class="form-group">
<label>shift</label>
<input type="text" class="form-control" name="father_name"  value="{{ $doctor->shift }}">
</div>
<div class="form-group">
<label>doctor specialization</label>
<input type="text" class="form-control" name="doctor_type"  value="{{ $doctor->specialization }}">
</div>
