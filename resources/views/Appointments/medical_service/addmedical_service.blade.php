...
<h5 class="text-uppercase mb-0 mt-0 page-title">Add Medical Service</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="{{ route('appointments.index') }}"><I class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="">Medical Service</a></li>
<li class="breadcrumb-item"><span> Add Medical Service</span></li>
</ul>
</div>
</div>
</div>
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<form   method="POST" action="{{ route('medical_service.store') }}">
	@csrf
...
<div class="form-group">
	<label>Devices assocciated with</label>
	{{-- <input type="text" class="form-control" name="service_devices"> --}}
	<select class="form-control select" name="service_devices">
		@foreach ($medicaldevice as $item )
		<option value="{{$item->name }}">{{$item->name }}</option>
	    @endforeach
		

	</select>
	@error('service_devices')
<small class="form-text text-danger">{{ $message }}</small>
@enderror
	</div>

	<div class="form-group">
		<label>Price of Service</label>
