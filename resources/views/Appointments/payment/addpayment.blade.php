...
<h5 class="text-uppercase mb-0 mt-0 page-title">Add payments</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<input class="form-control " type="date"  name="pament_date">
@error('pament_date')
<small class="form-text text-danger">{{ $message }}</small>
@enderror
</div>
...
@livewire('payment-medicine')

</div>

<div class="form-group">
	<label>Total</label>
	<input type="text" class="form-control" id="totalpayment" name="total"><button id="clc2" class="btn btn-info">Calc</button>
	@error('total')
<small class="form-text text-danger">{{ $message }}</small>
@enderror
	</div>
