...
<h5 class="text-uppercase mb-0 mt-0 page-title">Add nurse</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span> Add nurse</span></li>
</ul>
</div>
</div>
</div>
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<form   method="POST" action="{{ route('payment_medicine.store') }}">
	@csrf
<div class="form-group">
<label>Service Name {{ $payment_id }}</label>
...
<div class="form-group">
	<label>Service Price</label>
	<input type="text" class="form-control" name="medicine_quantity">
	</div>
