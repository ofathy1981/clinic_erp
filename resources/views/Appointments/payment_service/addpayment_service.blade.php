...
<h5 class="text-uppercase mb-0 mt-0 page-title">Edit Payment Service</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="{{ route('appointments.index') }}"><I class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="">Payments</a></li>
<li class="breadcrumb-item"><span> Edit Payment Service</span></li>
</ul>
</div>
</div>
</div>
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<form   method="POST" action="{{ route('payment_service.store') }}">
	@csrf
