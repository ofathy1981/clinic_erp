...
<form ethod="POST" action="{{ route('nurse.search') }}">
	@csrf
			...
			<input type="text" class="form-control floating" name="nurse_id">
			<label class="focus-label">nurses ID</label>
			</div>
			</div>
			<div class="col-sm-6 col-md-3">
			<div class="form-group form-focus">
			<input type="text" class="form-control floating" name="nurse_name">
			<label class="focus-label">nurses Name</label>
			</div>
			</div>
			<div class="col-sm-6 col-md-3">
			<div class="form-group form-focus">
			<input type="text" class="form-control floating" name="nurse_mobile">
			...
			<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="{{route('nurse.show',$item->id)}}">{{   $item->first_name }}</a></h4>
