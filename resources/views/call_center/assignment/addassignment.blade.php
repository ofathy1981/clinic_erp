...
<h5 class="text-uppercase mb-0 mt-0 page-title">Add assignment</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span> Add assignment</span></li>
</ul>
</div>
</div>
</div>
...
<div class="form-group">
<label>completness</label>
<input type="text" class="form-control" name="completness">
@error('completness')
<small class="form-text text-danger">{{ $message }}</small>
@enderror
</div>
...
<div class="form-group">
	<label><strong>Contacts</strong></label><br></div> 
	<table class="table">
	<thead>
		<tr>
	...
	@foreach ($assign_contact as $item)
	<tr>
		<td><label><input type="checkbox" name="contact[{{ $loop->index }}]" value="{{$item->name}}"> {{$item->name}}</label>
		</td>
	<td>{{$item->phone}}</td>
	</tr>
	@endforeach
...
<div class="form-group">
	<label><strong>Groups</strong></label><br></div> 
	<table class="table">
	<thead>
		<tr>
	...
	@foreach ($assign_group as $item)
	<tr>
		<td><label><input type="checkbox" name="contact[{{ $loop->index }}]" value="{{$item->name}}"> {{$item->group_name}}</label>
		</td>
	</tr>
	@endforeach
</tbody>
