...
<h5 class="text-uppercase mb-0 mt-0 page-title">Edit contact</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<div class="form-group" name="social_case">
	<label>Address</label>
	<select class="form-control select" name="address"  value="{{ $contact->address }}">
...
<div class="form-group">
<label>contact specialization</label>
<input type="text" class="form-control" name="group"  value="{{ $contact->group }}">
</div>

<div class="form-group">
	<label>contact specialization</label>
	<input type="text" class="form-control" name="file_number"  value="{{ $contact->file_number }}">
	</div>
</div>
{{-- <div class="col-lg-12 col-md-12 col-sm-12 col-12">
