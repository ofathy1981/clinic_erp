...
<h5 class="text-uppercase mb-0 mt-0 page-title">Edit contact_group</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span> Add contact_group</span></li>
</ul>
</div>
</div>
</div>
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
	<form  action="{{ route('contact_group.update',$contact_group->id) }}" method="POST">
	@csrf
	@method('PUT')
	<input type="hidden" name="_method" value="PUT">
<div class="form-group">
<label>contact_group Name</label>
<input type="text" class="form-control" name="group_name"  value="{{ $contact_group->group_name }}">
