...
<div class="sidebar" id="sidebar">
     <div class="sidebar-inner slimscroll">
         <div id="sidebar-menu" class="sidebar-menu">
                                    ...
                                    <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/outcall.png')}}" width="35" height="35" alt="icon"> <span> OutGoing Call</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">


                                    @else  
                                    <a href="#" class=""><img src="{{ asset ('assets/img/sidebar/outcall.png')}}" width="35" height="35" alt="icon"> <span> OUTGOING CALLS</span> <span class="menu-arrow"></span></a>
                                    <ul class="list-unstyled" style="display: none;">
                                        @endif      

                                    @if(Route::current()->getName() == 'outgoing_call.index')
                                    
                                            <li  ><a  class="active" href="{{ route('patient.index') }}"><span>All Outgoing Calls</span></a></li>
                                    ...
                                    @else
                                    <li ><a  href="{{ route('assignment.create') }}"><span>Assign Calls To Agent</span></a></li>

                                    <li ><a  href="{{ route('outgoing_call.index') }}"><span>All Outgoing Calls</span></a></li>
                                    <li><a  href="{{ route('outgoing_call.create') }}"><span>New OutGoing Call</span></a></li>
                                    <li><a class="" href="{{ route('outgoing_call.index2') }}"><span>Edit Outgoing Call Data</span></a></li>
                                    <li ><a  href="{{ route('outgoing_call.calender') }}"><span>Schedule</span></a></li>
                                    <li><a href="{{ route('outgoing_call.followup_out') }}"><span>Follow-Up Calls</span></a></li>
                                    ...
                                    @if(Route::current()->getName() == 'incoming_call.index'|| Route::current()->getName() == 'incoming_call.create'|| Route::current()->getName() == 'incoming_call.edit')
                                        ...
                                        <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/icon-3.png')}}" width="35" height="35" alt="icon"> <span> Incoming Calls</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">
                                    @else
                                        <a href="#" class=""><img src="{{ asset ('assets/img/sidebar/incomecall.png')}}" width="35" height="35" alt="icon"> <span> Incoming Calls</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">
                                    @endif        
                                    ...
                                    @if(Route::current()->getName() == 'contact.index'|| Route::current()->getName() == 'contact.create'|| Route::current()->getName() == 'contact.edit')
                                            <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/icon-4.jpg')}}" width="35" height="35" alt="icon"> <span> Contacts</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @else
                                            <a href="#"><img src="{{ asset ('assets/img/sidebar/contacts.jpg')}}" width="35" height="35" alt="icon"> <span> Contacts</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @endif
                                    ...
                                    @if(Route::current()->getName() == 'callagent.index'|| Route::current()->getName() == 'callagent.create'|| Route::current()->getName() == 'callagent.edit')
                                            <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/callagent.png')}}" width="35" height="35" alt="icon"> <span> Call Agents</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @else
                                            <a href="#"><img src="{{ asset ('assets/img/sidebar/callagent.png')}}" width="35" height="35" alt="icon"> <span> Call Agents</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @endif
                                    ...
                                    @if(Route::current()->getName() == 'contact_group.index'|| Route::current()->getName() == 'contact_group.create'|| Route::current()->getName() == 'contact_group.edit')


                                            <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/contactgroup.jpg')}}" width="35" height="35" alt="icon"> <span> Contact Groups</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @else
                                            <a href="#"><img src="{{ asset ('assets/img/sidebar/contactgroup.jpg')}}" width="35" height="35" alt="icon"> <span> Contact Groups</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    ...
                                    @if(Route::current()->getName() == 'contact_group.index')
                                    <li><a href="{{ route('contact_group.index') }}" class="active" ><span>All Contacts Groups</span></a></li>
                                    <li><a href="{{ route('contact_group.create') }}"><span>New Contact Group</span></a></li>
                                    <li><a href="{{ route('contact_group.index2') }}"><span>Edit Group Data</span></a></li>
                                    </ul>
                                    </li>

                                    @elseif(Route::current()->getName() == 'contactgroup.create')
                                    <li><a href="{{ route('contact_group.index') }}"><span>All Contacts Groups</span></a></li>
                                    <li><a href="{{ route('contact_group.create') }}" class="active" ><span>New Contact Group</span></a></li>
                                    <li><a href="{{ route('contact_group.index2') }}"><span>Edit Group Data</span></a></li>
                                    </ul>
                                    </li>

                                    @elseif(Route::current()->getName() == 'contactgroup.index2')
                                    <li><a href="{{ route('contact_group.index') }}"><span>All Contacts Groups</span></a></li>
                                    <li><a href="{{ route('contact_group.create') }}"><span>New Contact Group</span></a></li>
                                    <li><a href="{{ route('contact_group.index2') }}" class="active" ><span>Edit Group Data</span></a></li>
                                    </ul>
                                    </li>
                                    ...
                                    <li><a href=""><span>Daily Calls Report</span></a></li>
                                    <li><a href=""><span>Calls According To service</span></a></li>
                                    </ul>
                                    </li>
