...
<div class="sidebar" id="sidebar">
     <div class="sidebar-inner slimscroll">
         <div id="sidebar-menu" class="sidebar-menu">
                                    ...
                                    <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/store.jpg')}}" width="35" height="35" alt="icon"> <span> Medical Stores</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">


                                    @else  
                                    <a href="#" class=""><img src="{{ asset ('assets/img/sidebar/store.jpg')}}" width="35" height="35" alt="icon"> <span> Medical Stores</span> <span class="menu-arrow"></span></a>
                                    <ul class="list-unstyled" style="display: none;">
                                        @endif      
                                    ...
                                    @else
                                    <li ><a  href="{{ route('assignment.create') }}"><span>New Medical Store</span></a></li>

                                    <li ><a  href="{{ route('outgoing_call.index') }}"><span>Medical Stores</span></a></li>
                                    <li><a  href="{{ route('outgoing_call.create') }}"><span>New OutGoing Call</span></a></li>
                                    ...
                                    @if(Route::current()->getName() == 'incoming_call.index'|| Route::current()->getName() == 'incoming_call.create'|| Route::current()->getName() == 'incoming_call.edit')
                                        ...
                                        <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/items.jpg')}}" width="35" height="35" alt="icon"> <span> Medical Items</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">
                                    @else
                                        <a href="#" class=""><img src="{{ asset ('assets/img/sidebar/items.jpg')}}" width="35" height="35" alt="icon"> <span>Medical Items</span> <span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled" style="display: none;">
                                    @endif        
                                    ...
                                    @if(Route::current()->getName() == 'contact.index'|| Route::current()->getName() == 'contact.create'|| Route::current()->getName() == 'contact.edit')
                                            <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/supplier.png')}}" width="35" height="35" alt="icon"> <span> Medical Suppliers</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @else
                                            <a href="#"><img src="{{ asset ('assets/img/sidebar/supplier.png')}}" width="35" height="35" alt="icon"> <span> Medical Suppliers</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @endif
                                    ...
                                    @if(Route::current()->getName() == 'callagent.index'|| Route::current()->getName() == 'callagent.create'|| Route::current()->getName() == 'callagent.edit')
                                            <a href="#" class="active"><img src="{{ asset ('assets/img/sidebar/trans.jpg')}}" width="35" height="35" alt="icon"> <span> Store Transactions</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @else
                                            <a href="#"><img src="{{ asset ('assets/img/sidebar/trans.jpg')}}" width="35" height="35" alt="icon"> <span> Store Transactions</span> <span class="menu-arrow"></span></a>
                                            <ul class="list-unstyled" style="display: none;">
                                    @endif
